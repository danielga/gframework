...
function _R.Entity:SetNetworkedVar(varname, value)
	gframework.networkedvar:SetEntityNetworkedVar(self, varname, value)
end

_R.Entity.SetNWVar = _R.Entity.SetNetworkedVar
...
gframework.hook:Add("EntityRemoved", "gframework.networkedvar.EntityRemoved", gframeworkEntityRemoved)
...
gframework.hook:Add("PlayerInitialSpawn", "gframework.networkedvar.PlayerInitialSpawn", gframeworkPlayerInitialSpawn)